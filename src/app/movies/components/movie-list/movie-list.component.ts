...
// container component that will be responsible handling and displaying the movie items and passing data down to the presentational components it will display
@Component({
